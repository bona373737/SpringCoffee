<template>
  <div>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-2">
      <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">관리자 페이지</a>
      <ul class="navbar-nav px-3">
        <li class="nav-item text-nowrap">
          <router-link to="/" class="nav-link" @click="changeShow">메인으로</router-link>
        </li>
      </ul>
    </nav>
      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <canvas
            ...
            width="585"
            height="247"
            style="display: block; width: 585px; height: 247px;"
          ></canvas>
        </main>
      </div>
    </div>
