...
import com.kosa.springcoffee.security.token.PreAuthorizationToken;
...
public class FormLoginAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication)
        ...
        // 3.
        UserDetails memberDB = memberService.loadUserByUsername(username);

        // 4.
        if (isCorrectPassword(password, memberDB.getPassword())) {
            return PostAuthorizationToken
                    .getTokenFormUserDetails(memberDB);
        }
